...
public partial class HyperOderOverViewBillViewComponent : NopViewComponent
{
    ...
    public HyperOderOverViewBillViewComponent(IShoppingCartModelFactory shoppingCartModelFactory,
